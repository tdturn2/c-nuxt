// PATCH degree-section. Auth: SSO. Forward to Payload PATCH /api/degree-sections/:id.
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    console.error('Degree-sections PATCH error:', err)
    if (err.statusCode) throw err
    throw createError({
      statusCode: err.statusCode || 500,
      statusMessage: err.statusMessage || 'Failed to update degree section',
      data: err.data,
    })
  }
})
